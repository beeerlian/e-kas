...
class _InputinvoiceState extends State<Inputinvoice> {
  ...
  void initState() {
    ...
    date = jiffy.date.toString();
    month = jiffy.month.toString();
    year = jiffy.year.toString();
    super.initState();
  }
    ...
    return WillPopScope(
      ...
      child: BlocConsumer<InvoiceBloc, InvoiceState>(
        listener: (context, state) {
          ...
          } else if (state is SaveIncomeSuccess ||
              state is SaveOutcomeSuccess) {
            Navigator.pushReplacementNamed(context, HomePage.ROUTE_NAME);
  ...
  void pickDate() {
    DatePicker.showDatePicker(context,
      ...
      Jiffy jiffy = Jiffy(datePicked, "dd-MM-yyyy");
